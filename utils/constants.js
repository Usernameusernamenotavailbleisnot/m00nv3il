// Central constants file for the Moonveil Network Automation Tool
module.exports = {
    // Network information
    NETWORK: {
      NAME: "Moonveil Testnet",
      CHAIN_ID: 1093502521,
      RPC_URL: "https://rpc.testnet.moonveil.gg",
      EXPLORER_URL: "https://blockscout.testnet.moonveil.gg",
      CURRENCY_SYMBOL: "MORE",
      FAUCET_URL: "https://faucet.testnet.moonveil.gg/api/claim"
    },
    
    // Bridge information
    BRIDGE: {
      CONTRACT_ADDRESS: "0x528e26b25a34a4A5d0dbDa1d57D318153d2ED582",
      SEPOLIA_CHAIN_ID: 11155111,
      MOONVEIL_CHAIN_ID: 1093502521,
      // When bridging from Sepolia to Moonveil use destination network ID = 22 (0x16)
      // When bridging from Moonveil to Sepolia use destination network ID = 0
      MIN_AMOUNT: "0.00001"  // Minimum bridge amount in ETH/MORE
    },
    ...
    FAUCET: {
      ...
      COOLDOWN_HOURS: 24 // Faucet cooldown period
    },
